...
INSERT INTO public.categoria(nombre, descripcion)
	VALUES ('EJEMPLO','CATEGORIA 1CATEGORIA 1CATEGORIA 1CATEGORIA 1');

INSERT INTO public.categoria(nombre, descripcion)
	VALUES ('URGENTE','CATEGORIA 2CATEGORIA 2CATEGORIA 2CATEGORIA 2');

INSERT INTO public.categoria(nombre, descripcion)
	VALUES ('HOGAR','CATEGORIA 3CATEGORIA 3CATEGORIA 3CATEGORIA 3');

INSERT INTO public.categoria(nombre, descripcion)
	VALUES ('TRABAJO','CATEGORIA 4CATEGORIA 4CATEGORIA 4CATEGORIA 4');
